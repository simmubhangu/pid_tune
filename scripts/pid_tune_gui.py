...
# 		self.scale = Scale(self.root, orient='horizontal', from_=0, to=300, label= 'Kp',width = "50", length = "500",troughcolor="red")
# 		self.scale1 =Scale(self.root, orient='horizontal', from_=0, to=1000, label= 'Ki',width = "50", length = "500",troughcolor="green")
# 		self.scale2 =Scale(self.root, orient='horizontal', from_=0, to=100, label= 'Kd',width = "50", length = "500", troughcolor="blue")
# 		# scale3 =Scale(root, orient='horizontal', from_=0, to=300, label= 'Kp_z',width = "50", length = "500", troughcolor="gray")
# 		self.scale.pack()
# 		self.scale1.pack()
# 		self.scale2.pack()
